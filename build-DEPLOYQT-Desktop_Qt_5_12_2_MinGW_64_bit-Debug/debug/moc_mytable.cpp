...
QT_MOC_LITERAL(1, 8, 20), // "sendRecordExeAddress"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "address"
QT_MOC_LITERAL(4, 38, 26), // "on_tableView_doubleClicked"
QT_MOC_LITERAL(5, 65, 11), // "QModelIndex"
QT_MOC_LITERAL(6, 77, 5) // "index"

    },
    "MYTABLE\0sendRecordExeAddress\0\0address\0"
...
void MYTABLE::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendRecordExeAddress((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MYTABLE::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MYTABLE::sendRecordExeAddress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MYTABLE::sendRecordExeAddress(QString _t1)
{
