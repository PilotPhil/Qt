...
RainFlow::RainFlow(QWidget *parent) : QWidget(parent)
{
...
//去除inp中重复连续数据,保留一个
//去除连续重复的数
void RainFlow::NoSame(QVector<qreal> *inp)
{
    qint8 all,index=0;;
    while(all!=index)
    {
...
//峰谷提取
void RainFlow::PeakVally(QVector<qreal> *inp)
{
...
//载荷历程调整
void RainFlow::PeriodAdjust(QVector<qreal> *inp)
{
